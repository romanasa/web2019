...
class HttpServer {
    ...
    private void process(Request request, Response response) throws IOException {
        ...
        String uri = URLDecoder.decode(request.getUri(), StandardCharsets.UTF_8);
    ...
    private String getContentType(File file) {
        ...
        if (path.endsWith(".html") || path.endsWith(".htm") || file.isDirectory()) {
            return "text/html";
        }
